# Run hypoxia model for None (with left fish)
...
params_test = params_tune
species_params(params_test)$R_max = c(7.2e+07,3.6e+08,6.0e+11,2.5e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(7.2e+07,3.6e+08,6.0e+11,2.5e+10)), log10(species_params(params_tune)$gamma))

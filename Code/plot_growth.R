# Load growth data
cod_smalk = read.csv("Data/SMALK_cod.csv")
flounder_smalk = read.csv("Data/SMALK_flounder.csv")
sprat_bias = read.csv("Data/BIAS_sprat.csv")
herring_bias = read.csv("Data/BIAS_herring.csv")

# Subset cod data
cod_smalk = cod_smalk[cod_smalk$Area %in% seq(25,29) & cod_smalk$Country == "SWE", ]

# Subset flounder data
flounder_smalk = flounder_smalk[flounder_smalk$Area %in% seq(25,29) & flounder_smalk$Country == "SWE", ]
flounder_smalk = flounder_smalk[flounder_smalk$Age < 50 & flounder_smalk$LngtClass < 1000, ]

# Subset sprat data
sprat_bias = sprat_bias[sprat_bias$Area %in% seq(25,29) & sprat_bias$Validity..haul. != "I", ]

# Subset herring data
herring_bias = herring_bias[herring_bias$Area %in% seq(25,29) & herring_bias$Validity..haul. != "I", ]

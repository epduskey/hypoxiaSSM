...
species_params(params_test)$z0 = c(0.06, 0.20, 0.30, 0.25)
...
# Fit yield
par_yield = c(0.06, 0.20, 0.30, 0.25)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.2e+08,4.2e+08,5.0e+11,2.4e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.2e+08,4.2e+08,5.0e+11,2.4e+10)), log10(species_params(params_tune)$gamma))

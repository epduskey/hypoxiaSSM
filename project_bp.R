...
# Last modified: December 20, 2022 by EPD
...
species_params(params_test)$z0 = c(0.05, 0.22, 0.30, 0.25)
...
# Fit yield
par_yield = c(0.05, 0.22, 0.30, 0.25)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.1e+08,4.2e+08,5.1e+11,2.3e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.1e+08,4.2e+08,5.1e+11,2.3e+10)), log10(species_params(params_tune)$gamma))

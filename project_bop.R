...
species_mat = sp_mat(rmax = c(3.7e+08,9.6e+08,2.1e+11,1.9e+10))
...
species_params(params_test)$gamma = c(8.9e-11, 4.4e-11, 2.3e-11, 3.0e-11)
...
species_params(params_tune)$gamma = c(8.9e-11, 4.4e-11, 2.3e-11, 3.0e-11)
par_occ = c(0.8, 0.1)
...
params_test = params_tune
species_params(params_test)$R_max = c(1.1e+08,4.4e+08,5.1e+11,2.3e+10)
sim_test = project(params_test, t_max = t_tune, effort = effort_hypoxia)
plotBiomassObservedVsModel(sim_test)
plotBiomass(sim_test)

# Fit biomass and growth
par_bg = c(log10(c(1.1e+08,4.4e+08,5.1e+11,2.3e+10)), log10(species_params(params_tune)$gamma))
